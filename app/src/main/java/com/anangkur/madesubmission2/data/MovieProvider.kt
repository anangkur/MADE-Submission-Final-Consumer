package com.anangkur.madesubmission2.data
...
import com.anangkur.madesubmission2.data.local.room.ResultDao
...
class MovieProvider : ContentProvider(){
    ...
    private fun fromContentValues(values: ContentValues): Result {
        return com.anangkur.madesubmission2.data.model.Result(
